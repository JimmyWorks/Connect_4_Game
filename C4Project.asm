...
#Player1 Victory Sound
Music_VictoryP1_NoteCt:	.word	5
Music_VictoryP1_Note:	.word	69, 69, 71, 69, 71
Music_VictoryP1_Dur:	.word	250, 250, 250, 250, 750
Music_VictoryP1_Instr:	.word	80, 80, 80, 80, 80
Music_VictoryP1_Vol:	.word	90, 95, 100, 110, 120

#Player2 Victory Sound
Music_VictoryP2_NoteCt:	.word	5
Music_VictoryP2_Note:	.word	69, 69, 71, 69, 71
Music_VictoryP2_Dur:	.word	250, 250, 250, 250, 750
Music_VictoryP2_Instr:	.word	96, 96, 96, 96, 96
...
Player1Wins:
	...
	la	$t4, Music_VictoryP1_NoteCt
	lw	$t4, ($t4)			# $t4 loaded with number of notes
	la	$t0, Music_VictoryP1_Note	# $t0 must be loaded with base address of array of notes
	la	$t1, Music_VictoryP1_Dur	# $t1 must be loaded with base address of array of duration of note
	la	$t2, Music_VictoryP1_Instr 	# $t2 must be loaded with base address of array of instrument of note
	la	$t3, Music_VictoryP1_Vol	# $t3 must be loaded with base address of array of volume of note
	jal	PlaySound			#play sound
